...
export default async function GuideArticlePage({ params }: GuidePageProps) {
  ...
  return (
    <>
      <NewsArticleJsonLd article={article} locale="en" section="guides" />
      <ArticleFaqJsonLd article={article} locale="en" />
      <NewsDetail article={article} locale="en" section="guides" />
    </>
  );
}
