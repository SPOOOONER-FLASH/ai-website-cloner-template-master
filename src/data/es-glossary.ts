...
export const PRODUCT_NAMES_ES: Record<string, string> = {
  ...
  */
  ...
  "Robe Hook": "Gancho de pared",
  "Coat and Hat Hook": "Gancho para abrigo y sombrero",
  "Double Robe Hook": "Gancho doble de pared",
  "Barrel Bolt": "Pasador de sobreponer",
  "Flat Slide Bolt": "Pasador plano",
  "Spring Latch": "Pestillo de resorte de sobreponer",
  "Towel Ring": "Toallero de aro",
  "Toilet Roll Holder": "Portarrollos",
  "Toilet Roll Holder with Cover": "Portarrollos con tapa",
  "Toilet Roll Holder with Shelf": "Portarrollos con repisa",
  "Paper Towel Dispenser": "Dispensador de toallas de papel",
  "Jumbo Roll Dispenser": "Dispensador de papel higiénico jumbo",
  "Soap Dish": "Jabonera",
  "Wire Soap Dish": "Jabonera de rejilla",
  "Shower Basket": "Canasta para ducha",
  "Corner Shower Basket": "Canasta esquinera para ducha",
  "Two-Tier Corner Shower Basket": "Canasta esquinera doble para ducha",
  "Towel Shelf with Hooks": "Repisa toallero con ganchos",
  "Towel Shelf": "Repisa toallero",
  "Towel Bar": "Toallero de barra",
  "Soap Dispenser": "Dispensador de jabón",
  "Two-Tier Shower Shelf": "Repisa doble para ducha",
  "Shower Shelf": "Repisa para ducha",
  "Two-Tier Corner Shower Shelf": "Repisa esquinera doble para ducha",
  "Corner Shower Shelf": "Repisa esquinera para ducha",
  "Fold-Down Shower Seat": "Asiento de ducha abatible",
  "Double Flip-Up Grab Bar": "Barra de apoyo abatible doble",
