...
/**
 * The seven overlay trees, 2026-09-25.
 *
 * Generated by scripts/scaffold-locale-routes.mjs with the Portuguese route set. The same
 * two assertions as above: every route that hreflang advertises (hasOverlayMirror) exists
 * on disk in every overlay tree, and no overlay tree carries a route the mirror list does
 * not know about. Portuguese is the reference because the seven were cut from it.
 */
test("every overlay locale carries exactly the Portuguese route set", async () => {
