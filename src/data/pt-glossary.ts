...
export const PRODUCT_NAMES_PT: Record<string, string> = {
  ...
  */
  ...
  "Robe Hook": "Gancho de parede",
  "Coat and Hat Hook": "Gancho para casaco e chapéu",
  "Double Robe Hook": "Gancho duplo de parede",
  "Barrel Bolt": "Ferrolho de sobrepor",
  "Flat Slide Bolt": "Ferrolho chato",
  "Spring Latch": "Fecho de mola de sobrepor",
  "Towel Ring": "Porta-toalha de argola",
  "Toilet Roll Holder": "Porta-papel higiênico",
  "Toilet Roll Holder with Cover": "Porta-papel higiênico com tampa",
  "Toilet Roll Holder with Shelf": "Porta-papel higiênico com prateleira",
  "Paper Towel Dispenser": "Dispenser de papel toalha",
  "Jumbo Roll Dispenser": "Dispenser de papel higiênico rolão",
  "Soap Dish": "Saboneteira",
  "Wire Soap Dish": "Saboneteira aramada",
  "Shower Basket": "Cesto aramado para banho",
  "Corner Shower Basket": "Cesto aramado de canto",
  "Two-Tier Corner Shower Basket": "Cesto aramado de canto duplo",
  "Towel Shelf with Hooks": "Prateleira porta-toalhas com ganchos",
  "Towel Shelf": "Prateleira porta-toalhas",
  "Towel Bar": "Porta-toalha de barra",
  "Soap Dispenser": "Dispenser de sabonete",
  "Two-Tier Shower Shelf": "Prateleira dupla para box",
