          ...
          */}
          <div className="mt-32 hidden lg:block" aria-hidden="true">
            ...
            <div className="mt-12 h-px w-full bg-line">
              <div
                className="h-px bg-ink motion-safe:transition-[width] motion-safe:duration-[var(--motion-medium)]"
            ...
            return (
              ...
              >
                <div className="flex gap-24">
                  <span
                    className={[
                      "shrink-0 text-c2 tabular-nums motion-safe:transition-colors motion-safe:duration-[var(--motion-medium)]",
