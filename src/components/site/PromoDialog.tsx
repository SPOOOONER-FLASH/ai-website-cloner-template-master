...
function PromoCardBlock({
  ...
  const ctaClass =
    "short-marker short-marker-compact text-c1 text-surface transition-opacity duration-fast hover:opacity-80";
  ...
  return (
    <div className="hard-shadow-panel relative bg-surface">
      <button
        ...
        className="absolute right-12 top-12 z-10 flex h-24 w-24 items-center justify-center text-ink transition-colors duration-fast hover:text-ink-secondary"
      >
