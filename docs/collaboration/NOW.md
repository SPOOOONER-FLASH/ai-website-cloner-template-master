...
| Claude HYDE 文案（johns 机器，tmp/claude-copy） | content/news、content/guides 的 bodyEs / bodyPt（逐篇改写，每批 3 篇）；docs/copy/style-guides/ | 甲方 09-24：B 端方向，西葡逐篇改写，三语页面文字归 Claude。批次见 tasks/2026-09-24-copy-style-rewrite.md。**不碰** seoTitle*/seoDescription*、category-positioning.json 和 198 条葡语摘要（E: 那一行在做） | 2026-09-24 |
