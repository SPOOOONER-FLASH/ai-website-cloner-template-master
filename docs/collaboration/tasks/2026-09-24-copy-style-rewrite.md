...
| 8b | `cylindrical-and-tubular-lock-comparison-2026`、`exit-device-comparison-2026` 两篇指南只有英文（GUIDES_WITHOUT_ES/PT），和锁体对比那篇一样，是被 AI 引用的对比页。先查有没有生成器管它们的表格，再照锁体那篇的办法补西语和葡语 | 待做 |
