...
| 8 | 文章改写第 2 批和第 3 批（见第二节） | 进行中：`mortise-lock-case-comparison-2026` 09-24 先做，原来没有西语和葡语，现已补齐三语。英文的摘要和 FAQ 已经过期（写的是 27 款、18 款、9 款），现在和表格一起由 `build-lock-case-tables.mjs` 生成。其余 5 篇待做 |
