...
先为 5 个位置各生成 3 张候选，共 15 张。候选是预览材料，不直接进入正式站。用户选择后，只将
5 张定稿复制到 `public/images/editorial/`，生成响应式 WebP，并更新英文、西语、alt 和
`IMAGE_CREDITS.md`。
...
- 5 张定稿原尺寸检查、15 张候选用途对照、响应式候选完整性；
...
3. 15 张预览；逐组评分并继续提交 5 张定稿与文案，发布前接受用户覆盖选择。
4. 白底产品图品牌修复。
5. 尺寸/横幅图品牌修复。
