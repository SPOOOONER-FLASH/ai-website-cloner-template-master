...
scene('curated-311-construction','technical',two(p('311-panic-exit-device',2),p('311-panic-exit-device',3)),'311 / CONSTRUCTION','Original catalogue views - outside trim selected separately','02'),
scene('curated-305-components','oak',two(p('305-fire-door-panic-exit-device',2),p('305-fire-door-panic-exit-device',3)),'305 / COMPONENTS','The parts and views shown in the original 305 catalogue','05'),
scene('curated-lc14-details','white',two(p('lc14-85-50mm-lock-case',2),p('lc14-85-50mm-lock-case',3)),'LC14 / DETAIL STUDY','Original catalogue views - no unverified cylinder or lever added','03'),
...
scene('curated-document-reference','white',two(p(KN,2),p(LC,2)),'FACTORY DRAWING REFERENCES','Original catalogue drawings - open each product for its dimensions')
];
const news={
'why-the-catalogue-is-this-wide':['curated-catalogue-range','Original catalogue photographs of 311, 607 SSET and 9004S, presented as individual models.','Fotografías originales de los modelos 311, 607 SSET y 9004S, presentados por separado.'],
