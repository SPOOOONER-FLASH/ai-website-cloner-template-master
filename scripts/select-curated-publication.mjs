...
add('curated-305-components','05','305 device and components shown in its catalog photography. Confirm the complete door configuration before ordering.','Dispositivo 305 y componentes de su fotografía de catálogo. Confirme la configuración completa de la puerta antes del pedido.');
add('curated-glass-patch-components','06','Components from the original glass door hardware catalog photograph. Glass preparation and compatibility are confirmed per project.','Componentes de la fotografía original del catálogo de herrajes para puertas de vidrio. Los mecanizados y la compatibilidad se confirman para cada proyecto.');
