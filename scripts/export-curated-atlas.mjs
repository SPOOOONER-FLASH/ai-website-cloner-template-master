...
fs.writeFileSync(`public/images/editorial/${id}.webp.json`,JSON.stringify({kind:'real-photograph-composition',sources:cfg.photos,scope:'Nine separate catalogue photographs; no installation scale or kit compatibility claim. Native Blender backdrop and mounts only.',scene:`${base}/${id}.blend`},null,2)+'\n');
