...
const selections=[
  {id:'311-warm-grey',slug:'311-panic-exit-device',en:'311 in a warm gray studio setting. Product photograph with an edited background.',es:'311 sobre un fondo de estudio gris cálido. Fotografía del producto con fondo editado.'},
