...
await fs.writeFile('docs/design-references/2026-09-21-guides-visuals/provenance.json',JSON.stringify({source,sha256:crypto.createHash('sha256').update(input).digest('hex'),method:'Generated empty architectural reference desk; contains no hardware. Catalogue product photographs are rendered separately, without geometric editing.',outputs:[960,1600].map(w=>`/images/editorial/guides-reference-desk-${w}.webp`)},null,2)+'\n');
